...
<h1> <span class="red">ATTENTION:</span> Sign up below to <br />get access to <span class="red">Affiliate Video Bots</span><br /> & all of our product launches<br /> before anyone else!</h1> 
...
<div id="form">
    <h3 class="red">Access the latest releases</h3>
    <h4>Never miss a product launch again</h4>
    ...
    <input type=hidden name="series" value="productlaunches">
