	...
	<div class="moduleBody">
	    ...
	    <tr>
	        <td> 
	            Website URL: </td>
	        <td>
	        	<div title="header=[Website URL] body=[URL of this website <br /> ex: www.domain.com <br /> Only put the top level domain] ">
	                <img src="<?=$helpImg?>" />
...
<center><input type="submit" name="update" value=" Save Settings " class="btn success" /></center>
